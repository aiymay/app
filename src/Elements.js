...
<ul class="topmenu">
  ...
  <li className="menu11">
    ...
    <img className="img1" alt ='img1' src={back2} />
      ...
      <div className="site">
       ...
       <div className="item1">
        <center><p><a className="rollover1"> </a></p></center>
      ...
      <div className="item2">
        <center><p><a className="rollover2"> </a></p></center>
      ...
      <div className="item3">
        <center><p><a className="rollover3"> </a></p></center>
    ...
    <div className="container1">
        ...
        <p><a className="rollover11"> </a></p>
      </div>

    <div className="lines">
    {lang.lang === "En"?<p>Kazakh yurt</p>:<p>Казахская юрта</p>}
        <img class="line1" src={line2} alt ='line2'/>
        </div>
        <div className="blocks1">
       <div className="item1">
        <center><p><a className="rollover21"> </a></p></center>
      ...
      <div className="item2">
        <center><p><a className="rollover22"> </a></p></center>
      ...
      <div className="item3">
        <center><p><a className="rollover23"> </a></p></center>
    ...
    <div className="container1">
      ...
      {lang.lang === "En"?<p>Kazakh equestrian games</p>:<p>Казахские конные игры</p>}
        ...
        <div className="blocks1">
       <div className="item1">
        <center><p><a className="rollover31"> </a></p></center>
      ...
      <div className="item2">
        <center><p><a className="rollover32"> </a></p></center>
      ...
      <div className="item3">
        <center><p><a className="rollover33"> </a></p></center>
...
https://musicnews.kz/wp-content/uploads/2013/02/2_IMG_2963.jpg  </p>
    ...
    <img class="orn4" src={orn2} alt ='orn2' />
    </div>
