...
<ul className="topmenu">
  ...
  {lang.lang === "En"?<p>Our articles</p>:<p>Наши статьи</p>}
    ...
    <img className="img1" src={back6} alt='back6'/>
      ...
      <div className="site3">
       ...
       <div className="item1">
        <center><p><a className="rollover35"> </a></p></center>
      ...
      <div className="item2">
        <center><p><a className="rollover36"> </a></p></center>
      ...
      <div className="item3">
        <center><p><a className="rollover37"> </a></p></center>
    ...
    {lang.lang === "En"?<p>Ancient wedding customs</p>:<p>Древние свадебные традиции</p>}
        ...
        <div className="blocks1">
       <div className="item1">
        <center><p><a className="rollover45"> </a></p></center>
      ...
      <div className="item2">
        <center><p><a className="rollover46"> </a></p></center>
      ...
      <div className="item3">
        <center><p><a className="rollover47"> </a></p></center>
...
<div className="site2">
    ...
    <div className="container1">
      ...
      {lang.lang === "En"?<p>Kazy, Sirne, Irimshik</p>:<p>Казы, Сірне, Ірімшік</p>}
        ...
        <div className="blocks1">
       <div className="item1">
        <center><p><a className="rollover55"> </a></p></center>
      ...
      <div className="item2">
        <center><p><a className="rollover56"> </a></p></center>
      ...
      <div className="item3">
        <center><p><a className="rollover57"> </a></p></center>
...
https://i.ytimg.com/vi/GdP2vJqxwj8/maxresdefault.jpg </p>
    ...
    <div className="blockk">
      <img className="orn3" src={orn2} alt='orn3'/>
      <center>
      <div className="end">
    ...
    <img class="orn4" src={orn2} alt='orn4'/>
    </div>
