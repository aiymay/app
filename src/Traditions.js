  ...
  {lang.lang === "En"?<p>Our articles</p>:<p>Наши статьи</p>}
    ...
    <img className="img1" src={back3} alt='back3' />
      ...
      <div className="site">
       ...
       <div className="item1">
        <center><p><a className="rollover41"> </a></p></center>
      ...
      <div className="item2">
        <center><p><a className="rollover42"> </a></p></center>
      ...
      <div className="item3">
        <center><p><a className="rollover43"> </a></p></center>
    ...
    {lang.lang === "En"?<p>Nauryz traditions</p>:<p>Традиции Наурыза</p>}
        ...
        <div className="blocks1">
       <div className="item1">
        <center><p><a className="rollover61"> </a></p></center>
      ...
      <div className="item2">
        <center><p><a className="rollover62"> </a></p></center>
      ...
      <div className="item3">
        <center><p><a className="rollover63"> </a></p></center>
    ...
    <div className="container1">
      ...
      {lang.lang === "En"?<p>Traditions related to the child in the family</p>:<p>Традиции связанные с ребенком в семье</p>}
        ...
        <div className="blocks1">
       <div className="item1">
        <center><p><a className="rollover71"> </a></p></center>
      ...
      <div className="item2">
        <center><p><a className="rollover72"> </a></p></center>
      ...
      <div className="item3">
        <center><p><a className="rollover73"> </a></p></center>
