  ...
  <li className='menu11'>
    ...
    <div className="block22"></div>
      ...
      <div className="item-main">
        <img src="https://previews.123rf.com/images/byheaven/byheaven1505/byheaven150500013/39640619-dombra-kazakh-instrument-apples-and-baursak-dish-on-the-grass-at-sunset-sky.jpg" />
        </div>
    ...
    {lang.lang == "En"?<div className="text-main"><p>Elements of Kazakh culture originate from ancient times of Kazakhstan's history and encapsulate the peculiarities of the nomadic way of life. Elements of Kazakh culture include national clothing, literature, yurts, handicrafts and equestrian games.</p></div>:<div className="text-main"><p>Элементы казахской культуры берут свое начало с древнейших времен истории Казахстана и заключают в себе особенности кочевого образа жизни. К элементам казахской культуры относятся национальная одежда, литература, юрты, ремесла и конные игры.</p></div>}
      ...
      <div className="item-main11">
        <center><img src={kyz} /></center>
        </div>

      <div className="item-main21">
        <center><img src="https://assembly.kz/upload/iblock/726/7263f7e6ae4783627837738d36d419a0.jpg" /></center>
      </div>

      <div className="item-main31">
        <center><img src="https://almaty.tv/news_photo/1616220144_news_b.jpeg" /></center>
      </div>
    </div>
    ...
    <div className="elements11">
      <div className="item-main11">
        <center><img src="https://massaget.kz/userdata/news/news_40355/image_l.jpg" /></center>
        </div>

      <div className="item-main21">
        <center><img src="http://www.zharar.com/uploads/posts/2016-07/1469527372_42c4c4.jpg" /></center>
      </div>

      <div className="item-main31">
        <center><img src="https://massaget.kz/userdata/news/news_37875/image_b.jpg" /></center>
      </div>
    </div>
    ...
    <div className="elements-main2">
      ...
      <div className="item-main3">
        <center><img src="https://toibiznes.kz/imagecache/original/images/16062017115207_f3ccdd27d2000e3f9255a7e3e2c48800.jpg" /></center>
      </div>
    </div>
